...
- **활발한 개선기 (초기)** — 1주 ~ 1달에 한 번씩 새 버전이 나올 수 있어요. 봇 상단 배너가 뜨면 여유 있을 때 🟠 업데이트하기 프롬프트 실행 (30초 소요, 팀 정책 파일 절대 안 건드림)
- **안정기** — 분기 1회 정도로 충분
- **⚠️ SECURITY 표기된 release** — 즉시 적용 권장 (배너가 뜨자마자)

배너 안 나오게 하려면 [나중에] 눌러서 그 버전만 dismiss (다음 새 버전엔 다시 뜸).
